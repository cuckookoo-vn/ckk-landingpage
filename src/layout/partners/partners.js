        ...
        <div id="partners">
                ...
                <div className="our-partners">
                    {
                        windowDimensions.width >767.5 ?
                            <>
                                <span className="title-main1">{t("partners.ourPartners.titleMain1")}</span>
                                <span className="title-main2">{t("partners.ourPartners.titleMain2")}</span>
                            </>
                            :
                            <span className="title-main">{t("partners.ourPartners.titleMain1")} {t("partners.ourPartners.titleMain2")}</span>
                    }
            ...
            <div className="container-child">
                <div className="review">
                    ...
                    <Swiper
                        direction={ windowDimensions.width > 767.5 ? "vertical" : "horizontal"}
                        slidesPerView={1}
                        spaceBetween={30}
                        slidesPerGroup={1}
                        mousewheel={true}
